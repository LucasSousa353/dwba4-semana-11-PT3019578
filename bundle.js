...
function App() {
  const institutoNome = 'O Instituto Federal de Educação, Ciência e Tecnologia de São Paulo';
  const institutoEndereco = 'Localizado em Rua Pedro Vicente, 625 - Canindé - São Paulo - SP - Brasil - Cep: 01109-010';

  return (
    <div>
      <p>{institutoNome} - é uma autarquia federal de ensino.</p>
      ...
      <p>Com a mudança, {institutoNome} passou a destinar 50% das vagas para os cursos técnicos e, no mínimo, 20% das vagas para os cursos de licenciatura, sobretudo nas áreas de Ciências e da Matemática. Complementarmente, continuará oferecendo cursos de formação inicial e continuada, tecnologias, engenharias e pós-graduação.</p>
      <p>“Além dos cursos presenciais, o {institutoNom  e} oferece os cursos Técnicos em Administração e em Informática para Internet e, a partir de 2012, o superior de Formação de Professores na modalidade de Ensino a Distância (EaD).</p>
